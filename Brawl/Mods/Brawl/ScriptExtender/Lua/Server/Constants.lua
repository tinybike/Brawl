...
Constants.DEBUG_LOGGING = {TurnOrder = true, RealTime = true, Swarm = true, Pause = true, Actions = true, Pick = true, AI = true, Movement = true, Listeners = true, Resources = true, Quests = true}
...
Constants.RANGED_RANGE_MAX = 18
Constants.RANGED_RANGE_SWEETSPOT = 10
Constants.RANGED_RANGE_MIN = 1.5
Constants.THROWN_RANGE_MAX = 18
Constants.THROWN_RANGE_MIN = 1.5
...
Constants.MELEE_WEAPON_SLOT = 3
Constants.RANGED_WEAPON_SLOT = 5
...
Constants.ETHEL_ILLUSION = "66b0ba70-059e-47ec-81c7-8434ab263f79"
